...
class AgentCulturalAdmin(ImportExportModelAdmin):
    ...
    'disability', 'population_group', 'rut', 'code_rut', 'country', 'state', 'city', 'zone', 'adress', 'zona','housing_stratum', 'phone_movil', 'phone',
    'email', 'health_regimen', 'pension_regimen', 'monthly_income', 'activity','vigia_patrimonio','portador_manifestacion','manifestation','created')
    list_display_links = ('pk',)
    ...
    fieldsets = (
        ...
        ('Actividad', {
            'fields': (('activity','vigia_patrimonio','portador_manifestacion','manifestation','formacion','mas_formacion','experiencia',)),
...
class EntidadAdmin(ImportExportModelAdmin):
    ...
    list_display = (
    'pk', 'user', 'name', 'sigla', 'nit', 'date', 'reseña', 'nombre_representante', 'apellidos_representante',
    'type_document', 'identification', 'lugar_expedicion', 'nombre_contacto', 'apellidos_contacto', 'cargo', 'vinculacion',
    ...
    fieldsets = (
        ...
        ('3. DATOS DEL CONTACTO DE LA ORGANIZACIÓN', {
            'fields': (('nombre_contacto', 'apellidos_contacto', 'cargo', 'vinculacion',
        'state', 'city', 'zone', 'zona', 'direccion', 'correspondencia', 'phone_movil', 'phone', 'apartado_aereo', 'email',
         'pagina_web',),),
        ...
        ('8. FORMACION', {
            'fields': ((
                'imparte_formacion', 'modalidad', 'created',)),
