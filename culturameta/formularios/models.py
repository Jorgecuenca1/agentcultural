...
class Torneo(models.Model):
    ...
    archivo2 = models.FileField(verbose_name='', upload_to='torneo/file', blank=True, null=True, validators=[validate_file_size])
    ...
    archivo4 = models.FileField(verbose_name='Los participantes de las modalidades de Golpe Inédito, Pasaje Inédito, Poema Inédito, deberán enviar una (1) copia del texto de la obra, escrita en computador en letra Arial 12, marcada y firmada únicamente con el seudónimo del compositor. Adjuntar el documento en un solo PDF.  ', upload_to='torneo/file', blank=True, null=True, validators=[validate_file_size])
    created = models.DateTimeField(auto_now_add=True)
