...
class Torneo(models.Model):
    ...
    archivo2 = models.FileField(verbose_name='Adjuntar el audio formato punto wav, mp3 etc... y vídeo y/o videos (mínimo una cámara máximo tres cámaras grabando simultáneamente) FHD, 1080p o superior de la propuesta según sea la modalidad seleccionada: *', upload_to='torneo/file', blank=True, null=True)
